...
class bookingScr extends StatefulWidget {
  ...
  String ?droplocation;
   bookingScr({Key? key,this.pickupLocation,this.droplocation}) : super(key: key);
...
class _bookingScrState extends State<bookingScr> {
      ...
      child: WillPopScope(
                ...
                InkWell(
                  ...
                  onTap: () {
                    ...
                    if(pickupLocationcontroller.text.isEmpty){
                      customSnackbar(context,"Please Select PickUp Location".toString() );
                      // getNotifivcation();

                    }

                    else if(droplocationcontroller.text.isEmpty){
                      customSnackbar(context,"Please Select Drop Location".toString() );
                      // getNotifivcation();
                      ...
                      // }
                        ...
                        customSnackbar(context,"Please Select One Way/Two Way".toString() );

                      }

                      else if(fromdate==null){
                        customSnackbar(context,"Please Select Date".toString() );
                                  ...
                                  InkWell(
                                    onTap: () {
                                      setState(() {
                                        ...
                                        selectincityoroutcity='Out City';
                                      });
                            ...
                            child: Container(
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                      ...
                                      children: [
                                        fromdate!=null?
                                        Text('${fromdate}',style: TextStyle(fontWeight: FontWeight.bold,color: AppColors.tabtextColor),):
                                        Text('Select Date',style: TextStyle(fontWeight: FontWeight.bold,color: AppColors.tabtextColor),),
                                        SizedBox(width: 10,),
        ...
        //               ),
                          ...
                          Row(children: [
                            ...
                            Text('Start Time',style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold,color: AppColors.tabtextColor),),
                          ],),
                              ...
                              Padding(
                                ...
                                child: Row(
                                    ...
                                    children: [
                                      ...
                                      Text('${selectStrartTimeController.text.toString()}',style: TextStyle(fontWeight: FontWeight.bold,color: AppColors.tabtextColor),):
                                      Text('Select Start Time',style: TextStyle(fontWeight: FontWeight.bold,color: AppColors.tabtextColor),),
                                      SizedBox(width: 10,),
                          ...
                          //
                          //
                          //   Text('End Time',style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold,color: AppColors.tabtextColor),),
                          // ],),
                          //
                          //
                          //
                          ...
                          //             Text('${selectendTimeController.text.toString()}',style: TextStyle(fontWeight: FontWeight.bold,color: AppColors.tabtextColor),):
                          //             Text('Select End Time',style: TextStyle(fontWeight: FontWeight.bold,color: AppColors.tabtextColor),),
                          //             SizedBox(width: 10,),
                          //             Icon(Icons.watch_later_outlined,color: AppColors.primary,)
                          //
                          //           ]),
                          ...
                          Row(children: [
                            ...
                            Text('Reporting Time',style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold,color: AppColors.tabtextColor),),
                          ],),
                              ...
                              Padding(
                                ...
                                child: Row(
                                    ...
                                    children: [
                                      ...
                                      Text('${reportingTimecontroller.text.toString()}',style: TextStyle(fontWeight: FontWeight.bold,color: AppColors.tabtextColor),):
                                      Text('Select Reporting Time',style: TextStyle(fontWeight: FontWeight.bold,color: AppColors.tabtextColor),),
                                      SizedBox(width: 10,),
                                      Icon(Icons.watch_later_outlined,color: AppColors.primary,)
        ...
        //
        //
        //                           Text('${selecthour??""} Price',style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold,color: AppColors.tabtextColor),),
        //                           Spacer(),
  ...
  Future<void> getNightCharge() async {
    ...
    var request = http.MultipartRequest('GET', Uri.parse('${baseUrl}get_settings'));
...
if(val=="rt"){
  ...
  print("===my technic=======${reportingTimecontroller.text}===============");
  ...
  print("===my technic=======${selectStrartTimeController.text}===============");
  ...
  print("===my technic=======${selectendTimeController.text}===============");
